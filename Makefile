...
.DEFAULT_GOAL := help
.PHONY: greet blog sum primes avg help
project := greet blog sum primes avg
...
clean: clean_greet clean_calculator clean_blog clean_primes clean_sum clean_avg ## Clean generated files
	${RM_F_CMD} ssl/*.crt
	${RM_F_CMD} ssl/*.csr
	${RM_F_CMD} ssl/*.key
	${RM_F_CMD} ssl/*.pem
...
clean_sum: ## Clean generated files for sum
